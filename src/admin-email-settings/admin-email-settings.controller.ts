...
export class AdminEmailSettingsController {
  constructor(private readonly adminEmailSettingsService: AdminEmailSettingsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAdminEmailSettingDto: UpdateAdminEmailSettingDto) {
    return this.adminEmailSettingsService.update(+id, updateAdminEmailSettingDto);
  }
